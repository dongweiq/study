...
public class DBUtil {
	...
	public static Uri URI_MYLOCKER_DETAIL = HongheProvider.buildUri(LockersDetailBean.class);

	/**lockers增删改查*/
	public static boolean addLockersBean(Context context, LockersBean bean) throws Exception {
	...
	public static int updateLockersBean(Context context, LockersBean bean) {
		ContentResolver cr = context.getContentResolver();
		int result = cr.update(URI_MYLOCKER, bean.beanToValues(), "lockersid=?", new String[] { bean.lockersid });
		return result;
	}
	...
	public static int delLockersBean(Context context, String id) {
		ContentResolver cr = context.getContentResolver();
		int result = cr.delete(URI_MYLOCKER, "lockersid=?", new String[] { id });
		return result;
	}
	...
	public static LockersBean getLockersBean(Context context, String id) {
		ContentResolver cr = context.getContentResolver();
		Cursor cursor = cr.query(URI_MYLOCKER, null, "lockersid=?", new String[] { id }, null);
	...
	/**lockersDetail增删改查*/
	public static boolean addLockersDetailBean(Context context, LockersDetailBean bean) throws Exception {
	 ...
	 * @return
	 */
	public static int updateLockersDetailBean(Context context, LockersDetailBean bean) {
		ContentResolver cr = context.getContentResolver();
		int result = cr.update(URI_MYLOCKER_DETAIL, bean.beanToValues(), "lockerdetailsid=?", new String[] { bean.lockerdetailsid });
		return result;
	}
	...
	public static int delLockersDetailBean(Context context, String id) {
		ContentResolver cr = context.getContentResolver();
		int result = cr.delete(URI_MYLOCKER_DETAIL, "lockerdetailsid=?", new String[] { id });
		return result;
	}
	 ...
	 * @return
	 */
	public static LockersDetailBean getLockersDetailBean(Context context, String id) {
		ContentResolver cr = context.getContentResolver();
		Cursor cursor = cr.query(URI_MYLOCKER_DETAIL, null, "lockerdetailsid=?", new String[] { id }, null);
	 ...
	 * @return
	 */
	public static ArrayList<LockersDetailBean> getAllLockersDetailBean(Context context) {
		ContentResolver cr = context.getContentResolver();
		Cursor cursor = cr.query(URI_MYLOCKER_DETAIL, null, null, null, null);
